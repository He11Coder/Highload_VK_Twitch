...
|HLS                     |Стриминг, раздача контента пользователям|Широко используемый протокол для видеостримнга по HTTP от Apple. Удобен встроенной возможностью стриминга с технологией ABR Streaming (стриминг с адаптивным битрейтом) и передачи субтитров, а также поддерживает большое количество кодеков                  |
