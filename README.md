...
Как можно легко убедиться, модуль 7, а также все модули вида x.1 отвечают за сбор продуктовых и техничесих метрик с реализуемых сервисов. В качестве баз для хранения записей с метриками бы выбран VictoriaMetrics.
