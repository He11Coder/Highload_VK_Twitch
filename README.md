...
* Дополнительно может быть произведен роутинг исходя из бизнес логики самой платформы:
  ...
  * Балансироващик можно настроить так, чтобы стримы с конкретных каналов направлялись на конкретный Origin независимо от того, с какого PoP идет поток данных
