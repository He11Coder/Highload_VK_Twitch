...
$$ 16\space байт\mathit{ (uuid - id)} + 10\space байт\mathit{ (text - username)} + 40\space байт\mathit{ (text - email)} + 10\space байт\mathit{ (bytea - salt)} + 32\space байта\mathit{ (bytea - password)} + 500\space байт\mathit{ (text - description)} + 60\space байт\mathit{ (text - avatar url)} + 8\space байт\mathit{(timestamp - created\_at)}=676\space байт/пользователя $$
...
$$ 16\space байт\mathit{ (uuid - id)} + 16\space байт\mathit{ (uuid - author\_id)} + 60\space байт\mathit{ (text - record\_url)}=92\space байт/стрим $$
...
$$ 16\space байт\mathit{ (uuid - id)} + 16\space байт\mathit{(uuid - stream\_record\_id)} + 50\space байт\mathit{ (text - title)} + 500\space байт\mathit{ (text - description)} + 8\space байт\mathit{ (timestamp - created\_at)}=590\space байт/стрим $$
...
$$ 16\space байт\mathit{ (uuid - id)} + 16\space байт\mathit{ (uuid - stream\_record\_id)} + 16\space байт\mathit{ (uuid - author\_id)} + 400\space байт\mathit{ (text - message)} + 8\space байт\mathit{ (timestamp - created\_at)}=456\space байт/сообщение $$
...
$$ 16\space байт\mathit{ (uuid - viewer\_id)} + 16\space байт\mathit{ (uuid - stream\_record\_id)} + 8\space байт\mathit{ (timestamp - created\_at)} + 8\space байт\mathit{ (timestamp - updated\_at)}=48\space байт/запись $$
...
$$ 16\space байт\mathit{ (uuid - subscriber\_id)} + 16\space байт\mathit{ (uuid - author\_id)} + 8\space байт\mathit{ (timestamp - created\_at)}=40\space байт/запись $$
...
$$ 16\space байт\mathit{ (uuid - user\_id)} + 16\space байт\mathit{ (uuid - session\_id)} + 8\space байт\mathit{ (timestamp - created\_at)}=40\space байт/сессию $$
